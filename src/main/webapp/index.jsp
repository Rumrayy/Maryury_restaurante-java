...
<section>
         ...
         <table class="titulo">
              <tr class="title">
                    ...
                    <th><h1>GOOD CHEF</h1></th>
                </tr>
                </table>
         <center>
         <img width="1000" height="500" src="IMG/carne1.gif" alt="">
       ...
       <div>
       <center>
       	<h2>A todos les encanta nuestra comida</h2>		</div>
       ...
       <footer class="footer" border="1">
          ...
          <center>
           <img class="color-img"  decoding="async" loading="lazy" width="100" height="100" src="https://citasmedicasmaryury.com/wp-content/uploads/2023/10/bbq-free-img.png" class="attachment-full size-full wp-image-1159" alt="">															</div>
